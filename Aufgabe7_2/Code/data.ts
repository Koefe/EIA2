...
"Sahne": [
    { min: "0", max: "3", step: "1", alt: 0.50, name: "laktosefreie Sahne", value: 0, type: "radio", class: "Laktosefreie Sahne"},
    { min: "0", max: "3", step: "1", alt: 0, name: "ohne Sahne", value: 0, type: "radio", class: "ohne Sahne"},
    { min: "0", max: "3", step: "1", alt: 0.30, name: "Sahne", value: 0, type: "radio", class: "Sahne"}
],

"Behälter": [
    { min: "0", max: "3", step: "1", alt: 0.60, name: "Behalter Waffel", value: 0, type: "radio", class: "Waffel"},
    { min: "0", max: "3", step: "1", alt: 0.40, name: "Behalter Becher", value: 0, type: "radio", class: "Becher"}
